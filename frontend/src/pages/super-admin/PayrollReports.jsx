// // // src/pages/super-admin/PayrollReports.jsx
...
// //                 </span>
// //               </div>
// //               <p className="text-sm text-[#9CA3AF]">Monthly salary with leave balance</p>
// //             </div>
// //           </div>
// //         </div>
...
// //               </svg>
// //               <h2 className="text-base font-bold text-[#1A1A2E]">Report Filters</h2>
// //             </div>
...
// //         {!loading && !payrollData && (
// //           <div className="flex flex-col items-center justify-center rounded-2xl bg-white py-20 shadow-sm">
// //             <div className="mb-4 flex h-20 w-20 items-center justify-center rounded-3xl bg-[#FFF3E8]">
// //               <svg className="h-10 w-10 text-[#E8590C]/40" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
// //                 <path strokeLinecap="round" strokeLinejoin="round" d="M9 17.25v1.007a3 3 0 01-.879 2.122L7.5 21h9" />
// //               </svg>
// //             </div>
// //             <p className="text-base font-semibold text-[#1A1A2E]">Select filters & generate report</p>
// //             <p className="mt-1 text-sm text-[#9CA3AF]">Choose company, month and year to view payroll</p>
// //           </div>
// //         )}
...
// //                     <p className="text-[10px] uppercase tracking-wider text-gray-300">Working Days</p>
// //                     <p className="text-2xl font-bold text-[#F4A261]">{getWorkingDays()}</p>
// //                   </div>
// //                   <div className="rounded-xl bg-white/10 px-4 py-2 backdrop-blur">
// //                     <p className="text-[10px] uppercase tracking-wider text-gray-300">Required Hrs</p>
// //                     <p className="text-2xl font-bold text-[#F4A261]">{getRequiredHours()}h</p>
// //                   </div>
// //                 </div>
// //               </div>
// //             </div>
...
// //                 { label: 'Total Earned', value: payrollData.summary.total_earned, color: '#16a34a', bg: '#f0fdf4', isMoney: true },
// //                 { label: 'Net Payable', value: payrollData.summary.total_net_payable, color: '#E8590C', bg: '#FFF3E8', isMoney: true, highlight: true },
// //               ].map((s) => (
...
// //                         <th className="px-3 py-3 text-left text-[10px] font-bold uppercase tracking-widest text-[#9CA3AF]">
// //                           Sr
// //                         </th>
// //                         <th className="px-3 py-3 text-left text-[10px] font-bold uppercase tracking-widest text-[#9CA3AF]">
// //                           Employee
// //                         </th>
// //                         <th className="px-3 py-3 text-center text-[10px] font-bold uppercase tracking-widest text-emerald-700">
// //                           Present
// //                         </th>
// //                         <th className="px-3 py-3 text-center text-[10px] font-bold uppercase tracking-widest text-red-700">
// //                           Absent
// //                         </th>
// //                         <th className="px-3 py-3 text-center text-[10px] font-bold uppercase tracking-widest text-blue-700">
// //                           Leaves
// //                         </th>
// //                         <th className="px-3 py-3 text-center text-[10px] font-bold uppercase tracking-widest text-purple-700">
// //                           Carry→
// //                         </th>
// //                         <th className="px-3 py-3 text-left text-[10px] font-bold uppercase tracking-widest text-[#9CA3AF]">
// //                           Worked
// //                         </th>
// //                         <th className="px-3 py-3 text-center text-[10px] font-bold uppercase tracking-widest text-[#9CA3AF]">
// //                           Progress
// //                         </th>
// //                         <th className="px-3 py-3 text-right text-[10px] font-bold uppercase tracking-widest text-[#9CA3AF]">
// //                           Salary
// //                         </th>
// //                         <th className="px-3 py-3 text-right text-[10px] font-bold uppercase tracking-widest text-[#9CA3AF]">
// //                           Deduction
// //                         </th>
// //                         <th className="px-3 py-3 text-right text-[10px] font-bold uppercase tracking-widest text-[#E8590C]">
// //                           Net Pay
// //                         </th>
// //                       </tr>
// //                     </thead>
...
// //                               emp.total_progress_percent >= 100
// //                                 ? 'bg-emerald-100 text-emerald-700'
// //                                 : emp.total_progress_percent >= 80
// //                                 ? 'bg-amber-100 text-amber-700'
// //                                 : 'bg-red-100 text-red-700'
// //                             }`}>
// //                               {emp.total_progress_percent}%
// //                             </span>
// //                           </td>
...
// //                         </td>
// //                         <td className="px-3 py-4 text-right font-bold text-red-300 text-sm">
// //                           {formatINR(payrollData.summary.total_deduction)}
// //                         </td>
// //                         <td className="px-3 py-4 text-right">
// //                           <span className="rounded-lg bg-[#E8590C] px-3 py-1.5 text-sm font-extrabold">
// //                             {formatINR(payrollData.summary.total_net_payable)}
// //                           </span>
// //                         </td>
// //                       </tr>
// //                     </tbody>
...
// //                 <strong>💡 How it works:</strong> 2 leaves/month FREE (no deduction).
// //                 Unused leaves <strong>carry forward</strong> to next month.
// //                 Salary = (Worked Hours + Paid Leave Hours) / Required Hours × Monthly Salary.
// //               </p>
// //             </div>
// //           </>
// //         )}
...
//                 </span>
//               </div>
//               <p className="text-sm text-[#9CA3AF]">Monthly salary with leave carry forward</p>
//             </div>
//           </div>
//         </div>
...
//               </svg>
//               <p className="text-[11px] text-blue-900">
//                 <strong>💡 How it works:</strong> First 2 leaves/month are FREE (no deduction).
//                 Unused leaves <strong>carry forward</strong> to next month.
//                 Salary = (Worked Hours + Paid Leave Hours) / Required Hours × Monthly Salary.
//               </p>
//             </div>
...
//                         <th className="px-3 py-3 text-center text-[10px] font-bold uppercase tracking-widest text-[#9CA3AF]">Progress</th>
//                         <th className="px-3 py-3 text-right text-[10px] font-bold uppercase tracking-widest text-[#9CA3AF]">Salary</th>
//                         <th className="px-3 py-3 text-right text-[10px] font-bold uppercase tracking-widest text-[#9CA3AF]">Deduction</th>
//                         <th className="px-3 py-3 text-right text-[10px] font-bold uppercase tracking-widest text-[#E8590C]">Net Pay</th>
//                       </tr>
//                     </thead>
//                     <tbody className="divide-y divide-gray-50">
//                       {payrollData.employees.map((emp, idx) => (
