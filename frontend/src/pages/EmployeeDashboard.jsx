...
useEffect(() => {
  ...
  const statCards = [
    ...
    {
      label: 'Avg Per Day',
      value: monthlySummary?.avg_hours_per_day || '0h 0m',
      sub: `${monthlySummary?.holiday_count || 0} holidays`,
      color: '#7c3aed',
      bg: '#f5f3ff',
  ...
  const statusColors = {
    ...
    'half-day-leave':  { bg: 'bg-amber-50', text: 'text-amber-600', dot: 'bg-amber-400', label: 'Half Day' },
            ...
            <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
              <div>
                ...
                <p className="text-xs text-[#9CA3AF]">
                  ...
                  {monthlySummary.pending_hours && ` • ${monthlySummary.pending_hours} pending`}
                </p>
              </div>
              <div className="text-right">
                <p className="text-3xl font-extrabold bg-gradient-to-r from-[#E8590C] to-[#F4A261] bg-clip-text text-transparent">
                  {monthlySummary.completion_percent}%
                </p>
              </div>
            </div>
                    ...
                    <div className="flex flex-col h-full">
                      ...
                      {day.status !== 'future' && day.status !== 'weekend' && (
                        <div className="mt-auto">
                          ...
                          {(day.status === 'present' || day.status === 'in-progress') && day.minutes > 0 && (
                            <span className="text-[8px] font-bold sm:text-[9px]" style={{ color: sc.text }}>
